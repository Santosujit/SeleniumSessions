...
public class JavaScriptTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebDriverManager.chromedriver().setup();// Launch the WebDriverManager
		...
		// we created the object of JavaScriptUtil class so that we
		// can call
		// all the methods inside JavaScriptUtil class

//		System.out.println(jsUtil.getTitleByJS());//It will give you the title of the page using Javascript
//		
