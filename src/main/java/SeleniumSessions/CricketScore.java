...
//	System.out.println(getWicketTakerName("Kusal Mendis")); --gives you the wicket taker's name
//	
//	System.out.println(getWicketTakerName("Brendan Taylor"));
	...
	public static String getWicketTakerName(String playerName) {
		return driver.findElement(By.xpath("//a[text()='" + playerName + "']//parent::td//following-sibling::td/span"))
				.getText();// u give me the player name, this function will create By locator, and
							// WebElement at runtime
							// append the player name above
	}
	...
	public static List<String> getScoreList(String playerName) {
		...
		for (int i = 1; i < scoreList.size(); i++) {//i=1 as we are ignoring the 1st value
